...
```text
havoc.must(destination: Place<T>, reason)
...
A V1 não define comportamento indefinido como licença para apagar análise. Um comportamento-fonte inválido ou não modelado deve conservar diagnóstico e envelope adequado.
